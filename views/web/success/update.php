                    ...
                    <div class="ibox-content">
                        ...
                        ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" value="<?= $model->name ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">产品编号：</label>
                                <div class="col-sm-8">
                                    <input id="num" name="num" value="<?= $model->num ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <?php foreach ($type as $da) {
                                        if ($da->id == $model->type_id) {
                                            ?>

                                            <option value='<?= $da->id ?>' selected><?= $da->type_name ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="address" name="address" value="<?= $model->address ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                </div>
                            </div>
                            <div class="form-group">
