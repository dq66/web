    ...
    <script>
        ...
        $(function(){
            ...
            function caozuo(value,row,index){
                ...
                return `
                    <a href="../../web/success/update?id=${value}"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp;&nbsp;
...
//
        ...
        function add(){
            window.location.href="<?= Url::to(['web/success/add']) ?>";
        }
