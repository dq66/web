                    ...
                    <div class="ibox-content">
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="source" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">关键词：</label>
                                <div class="col-sm-8">
                                    <input name="keyword" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">内容：</label>
                                <div class="col-sm-8">
                                   <div id="content" aria-required="true" aria-invalid="true" class="error"></div>
                                </div>
                            </div>
